...
export const Features: Component = () => {
    ...
    const [isinViewSixtSvg, setIsInViewSixtSvg] = createSignal(false);
     onMount(()=>{
        createEffect(()=>{
            console.log(`first svg:${firstSvg()!.scrollHeight},second svg:${secondSvg()?.scrollHeight}`,2*secondSvg()!.scrollHeight+firstSvg()!.scrollHeight <= windowScrollPosition.y)
            if(windowScrollPosition.y>0 && firstSvg()!.scrollHeight>0) {
                ...
                if (2*secondSvg()!.scrollHeight+firstSvg()!.scrollHeight <= windowScrollPosition.y) {
                    console.log("true second")
                    setIsInViewSecondSvg(true)
                }

            if (3*thirdSvg()!.scrollHeight + secondSvg()!.scrollHeight  +firstSvg()!.scrollHeight <= windowScrollPosition.y) {
                console.log("third")
            ...
            if (9*fivthSvg()!.scrollHeight <= windowScrollPosition.y) {
                ...
                if (12*sixtSvg()!.scrollHeight <= windowScrollPosition.y) {
    ...
    return (
        <div class={feature_container}>
            <div class={left} ref={setFirstSvg} >
                ...
                <Show when={isinViewFirstSvg()} fallback={<div class={placeHolder}/>}>
            ...
            <div class={left} ref={setSecondSvg}>
                <Show when={isinViewSecondSvg()} fallback={<div   class={placeHolder}/>}>
                <svg
                    class={svg}
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <div class={left} ref={setThirdSvg}>
                <Show when={isinViewThirdSvg()} fallback={<div class={placeHolder}/>}>
...
<div class={left}/>
            ...
            <div class={left} ref={setFourthSvg}>
                <Show when={isinViewFourthSvg()} fallback={<div class={placeHolder}/>}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div class={left} ref={setFivthSvg}>
                <Show when={isinViewFivthSvg()} fallback={<div class={placeHolder}/>}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div class={left} ref={setSixtSvg}>
                <Show when={isinViewSixtSvg()} fallback={<div class={placeHolder}/>}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
