import { atoms } from "../../../../styles/atoms/atoms.ts";
import { useBraidTheme } from "../../../theme/BraidThemeContext.ts";
import {
    BackgroundProvider,
    useBackground,
    useBackgroundLightness,
} from "./BackgroundProvider.tsx";
import type { BoxBackgroundVariant, BoxProps } from "../Box.tsx";
import type {
    Background,
    BoxShadow,
} from "../../../../styles/atoms/atomic_properties.js";
import * as typographyStyles from "../../../typography/Typography.js";
...
const normaliseBackground = (background: ColoredBoxProps["background"]) => ({
    lightMode:
        typeof background === "object" ? background.lightMode : background,
    darkMode:
...
export const useColoredBoxClasses = ({
    ...
    if (background) {
        ...
        classList.push(
            typographyStyles.lightModeTone[lightnessMap[lightMode!]]
        );
...
export const ColoredBox = forwardRef<HTMLElement, ColoredBoxProps>(
    ({ component, background, boxShadow, className, ...props }, ref) => {
        const { backgroundContext, classList: colorClasses } =
            useColoredBoxClasses({ background, boxShadow });
